...
def get_args():
    ...
    # Play
    parser.add_argument('--model_path', help='path to model directory of trained agent', type=str, default='')
    ...
    parser.add_argument('--epochs', help='number of epochs', type=np.int32, default=500)
